...
//       <i>Specify size of memory pool (in bytes) that the USB Host Controller
//       <i>will use for USB communication data.
#define USBH1_HC_EHCI_MEM_POOL_SIZE     512
...
#define USBH1_CORE_THREAD_STACK_SIZE    640
